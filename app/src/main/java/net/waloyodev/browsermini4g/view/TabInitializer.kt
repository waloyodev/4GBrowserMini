...
import net.waloyodev.browsermini4g.di.DiskScheduler
import net.waloyodev.browsermini4g.di.MainScheduler
import net.waloyodev.browsermini4g.extensions.resizeAndShow
...
import net.waloyodev.browsermini4g.html.download.DownloadPageFactory
