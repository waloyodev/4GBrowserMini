package net.waloyodev.browsermini4g.html.bookmark
...
import net.waloyodev.browsermini4g.extensions.safeUse
import net.waloyodev.browsermini4g.favicon.FaviconModel
import net.waloyodev.browsermini4g.favicon.toValidUri
