package net.waloyodev.browsermini4g.dialog

import net.waloyodev.browsermini4g.MainActivity
import net.waloyodev.browsermini4g.R
import net.waloyodev.browsermini4g.constant.HTTP
import net.waloyodev.browsermini4g.controller.UIController
import net.waloyodev.browsermini4g.database.Bookmark
import net.waloyodev.browsermini4g.database.asFolder
...
import net.waloyodev.browsermini4g.extensions.copyToClipboard
...
import net.waloyodev.browsermini4g.utils.IntentUtils
