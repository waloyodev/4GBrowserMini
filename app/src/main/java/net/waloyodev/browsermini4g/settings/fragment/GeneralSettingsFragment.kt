...
import net.waloyodev.browsermini4g.constant.*
...
import net.waloyodev.browsermini4g.search.Suggestions
import net.waloyodev.browsermini4g.search.engine.BaseSearchEngine
import net.waloyodev.browsermini4g.search.engine.CustomSearch
