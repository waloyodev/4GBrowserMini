package net.waloyodev.browsermini4g.browser.fragment

import net.waloyodev.browsermini4g.R
import net.waloyodev.browsermini4g.adblock.allowlist.AllowListModel
import net.waloyodev.browsermini4g.animation.AnimationUtils
import net.waloyodev.browsermini4g.browser.BookmarksView
import net.waloyodev.browsermini4g.browser.TabsManager
import net.waloyodev.browsermini4g.browser.bookmark.BookmarkUiModel
...
import net.waloyodev.browsermini4g.di.NetworkScheduler
...
import net.waloyodev.browsermini4g.extensions.color
import net.waloyodev.browsermini4g.extensions.drawable
import net.waloyodev.browsermini4g.favicon.FaviconModel
...
import net.waloyodev.browsermini4g.utils.ThemeUtils
import net.waloyodev.browsermini4g.utils.UrlUtils
