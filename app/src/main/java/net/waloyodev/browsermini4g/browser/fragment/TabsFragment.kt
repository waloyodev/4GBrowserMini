...
import net.waloyodev.browsermini4g.browser.TabsView
import net.waloyodev.browsermini4g.browser.fragment.anim.HorizontalItemAnimator
import net.waloyodev.browsermini4g.browser.fragment.anim.VerticalItemAnimator
...
import net.waloyodev.browsermini4g.extensions.desaturate
import net.waloyodev.browsermini4g.extensions.drawTrapezoid
import net.waloyodev.browsermini4g.preference.UserPreferences
import net.waloyodev.browsermini4g.utils.DrawableUtils
import net.waloyodev.browsermini4g.utils.ThemeUtils
import net.waloyodev.browsermini4g.utils.Utils
import net.waloyodev.browsermini4g.view.BackgroundDrawable
