...
import net.waloyodev.browsermini4g.constant.INTENT_ORIGIN
import net.waloyodev.browsermini4g.constant.SCHEME_BOOKMARKS
import net.waloyodev.browsermini4g.constant.SCHEME_HOMEPAGE
...
import net.waloyodev.browsermini4g.view.BundleInitializer
import net.waloyodev.browsermini4g.view.LightningView
import net.waloyodev.browsermini4g.view.TabInitializer
import net.waloyodev.browsermini4g.view.UrlInitializer
