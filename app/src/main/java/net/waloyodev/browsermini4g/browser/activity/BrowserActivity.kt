...
package net.waloyodev.browsermini4g.browser.activity

import net.waloyodev.browsermini4g.IncognitoActivity
import net.waloyodev.browsermini4g.R
import net.waloyodev.browsermini4g.browser.*
...
import net.waloyodev.browsermini4g.constant.LOAD_READING_URL
import net.waloyodev.browsermini4g.controller.UIController
import net.waloyodev.browsermini4g.database.Bookmark
import net.waloyodev.browsermini4g.database.HistoryEntry
...
import net.waloyodev.browsermini4g.di.DatabaseScheduler
import net.waloyodev.browsermini4g.di.MainHandler
import net.waloyodev.browsermini4g.di.MainScheduler
import net.waloyodev.browsermini4g.di.injector
import net.waloyodev.browsermini4g.dialog.BrowserDialog
import net.waloyodev.browsermini4g.dialog.DialogItem
import net.waloyodev.browsermini4g.dialog.LightningDialogBuilder
import net.waloyodev.browsermini4g.extensions.*
import net.waloyodev.browsermini4g.html.bookmark.BookmarkPageFactory
import net.waloyodev.browsermini4g.html.history.HistoryPageFactory
import net.waloyodev.browsermini4g.html.homepage.HomePageFactory
import net.waloyodev.browsermini4g.interpolator.BezierDecelerateInterpolator
import net.waloyodev.browsermini4g.log.Logger
import net.waloyodev.browsermini4g.notifications.IncognitoNotification
import net.waloyodev.browsermini4g.reading.activity.ReadingActivity
import net.waloyodev.browsermini4g.search.SearchEngineProvider
...
import net.waloyodev.browsermini4g.ssl.SSLState
import net.waloyodev.browsermini4g.utils.*
import net.waloyodev.browsermini4g.view.*
import net.waloyodev.browsermini4g.view.SearchView
import net.waloyodev.browsermini4g.view.find.FindResults
