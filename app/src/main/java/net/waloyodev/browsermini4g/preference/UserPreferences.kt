package net.waloyodev.browsermini4g.preference

import net.waloyodev.browsermini4g.constant.DEFAULT_ENCODING
import net.waloyodev.browsermini4g.constant.NO_PROXY
import net.waloyodev.browsermini4g.constant.SCHEME_HOMEPAGE
import net.waloyodev.browsermini4g.device.ScreenSize
import net.waloyodev.browsermini4g.di.UserPrefs
import net.waloyodev.browsermini4g.preference.delegates.booleanPreference
import net.waloyodev.browsermini4g.preference.delegates.intPreference
import net.waloyodev.browsermini4g.preference.delegates.stringPreference
import net.waloyodev.browsermini4g.search.engine.GoogleSearch
import net.waloyodev.browsermini4g.utils.FileUtils
