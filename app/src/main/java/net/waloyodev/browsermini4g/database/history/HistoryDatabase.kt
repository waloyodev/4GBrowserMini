 ...
 */
package net.waloyodev.browsermini4g.database.history

import net.waloyodev.browsermini4g.database.HistoryEntry
import net.waloyodev.browsermini4g.database.databaseDelegate
import net.waloyodev.browsermini4g.extensions.firstOrNullMap
import net.waloyodev.browsermini4g.extensions.useMap
